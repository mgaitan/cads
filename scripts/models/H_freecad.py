...
Z_MICRO_SHELF_BOTTOM = (Z_OVEN_VISIBLE_TOP - 1.0) + FASCIA_H - TH
Z_MICRO_BASE = Z_MICRO_SHELF_BOTTOM + TH
...
# El liston llega exactamente hasta la cara inferior de H6.
LISTON_H_TOTAL = Z_MICRO_SHELF_BOTTOM - LISTON_Z0
LISTON_EXT = max(0.0, LISTON_H_TOTAL - LISTON_H)
