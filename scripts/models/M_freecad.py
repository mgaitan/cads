#!/usr/bin/env python3
"""Genera mesada M con hueco para anafe de apoyo.

Salida:
  - models/fcstd/M.FCStd
  - models/step/M.step
  - bom/M_bom.csv
"""
...
def main():
    ...
    fcstd = out_fcstd_dir / "M.FCStd"
    step = out_step_dir / "M.step"
    bom = out_bom_dir / "M_bom.csv"
    ...
    with open(bom, "w", newline="", encoding="utf-8") as f:
        ...
        w.writerow(
            ["TOTAL", "Resumen", "Totales_Herrajes", "", "", "", "", "", "0.000", 0]
        )
